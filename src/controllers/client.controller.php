...
class ClientController {
    ...
    public function newClient($name, $email, $password, $birthday, $favProduct) {
...
switch ($action) {
    case 'newClient':
        ...
        $controller->newClient($name, $email, $password, $birthday, $favProduct);
        break;
    case 'deleteClient':
    ...
    case 'updateClient':
        ...
        $controller->updateClient($name, $email, $password, $birthday, $favProduct);
        break;
    default:
